...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_Y_POS 190                // Y position of hotend
  ...
  #define FILAMENT_CHANGE_LOAD_FEEDRATE 30    // Load filament feedrate in mm/s - filament loading into the bowden tube can be fast
